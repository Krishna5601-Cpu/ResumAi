...
const questionItemSchema = z.object({
  ...
  intention: z
    .string()
    .description("The intention behind why this question is being asked."),
  answer: z
    .string()
    .description(
      "How to answer this question, what points to cover, and how to approach it.",
    ),
});
    ...
    .array(
      z.object({
        ...
        focus: z
          .string()
          .description(
            "The main focus of this day (e.g., Data Structures, System Design).",
          ),
        tasks: z
          .array(z.string())
